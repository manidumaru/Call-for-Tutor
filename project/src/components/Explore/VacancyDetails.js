...
const VacancyDetails = () => {
  ...
  useEffect(()=>{
    axios.get(`http://127.0.0.1:8000/api/vaccancy/${vacencyId}`)
     ...
     <div className="vacancy-details-info">
       <div className="vacancy-details-top">
         <div className="vacancy-details-top-img">
          ...
          {vacancyInfo.vaccancy_image === null ? <img src={school} alt="School"></img> : <img src={vacancyInfo.vaccancy_image} alt="School"></img> }  
